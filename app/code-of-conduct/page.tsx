      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-orange-500">Introduction</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-orange-500">Attribution</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-slate-300">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-orange-500">Why we have a Code of Conduct</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-slate-300">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-orange-500">General (German) Sauna Rules</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-orange-500">The Pledge</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-slate-300">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-orange-500">A Safe Environment</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-slate-300 mb-4">We aim to create a safe environment by:</p>
              <ul className="text-slate-300 list-disc pl-6 space-y-2 mb-6">
              ...
              <p className="text-slate-300 mb-4">Examples of unacceptable behaviour include:</p>
              <ul className="text-slate-300 list-disc pl-6 space-y-2">
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <CardTitle className="text-orange-500">Enforcement & Violations</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-slate-300 mb-4">
              ...
              <p className="text-slate-300 mb-4">
                Violations of the Code of Conduct may be reported by sending an email to the organiser <a href="mailto:techsauna@nopants.dev" className="text-orange-500 hover:text-orange-400">Sven Haiges (he/him)</a> or our member <a href="mailto:lbauer@magenta.de" className="text-orange-500 hover:text-orange-400">Lena Bauer (she/her)</a>. All reports will be reviewed and investigated. We will hear both sides and then take action we deem appropriate such as:
              </p>
              <ul className="text-slate-300 list-disc pl-6 space-y-2">
